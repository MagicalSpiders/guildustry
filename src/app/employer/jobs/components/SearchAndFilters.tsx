...
export function SearchAndFilters({
  ...
  const filterOptions = {
    trade: ["All Trades", "Electrical", "Plumbing", "HVAC", "Carpentry", "Welding"],
    location: ["All Locations", "New York, NY", "Brooklyn, NY", "Manhattan, NY", "Queens, NY"],
    salary: ["All Salaries", "$40k - $60k", "$60k - $80k", "$80k - $100k", "$100k+"],
