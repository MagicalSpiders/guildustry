    ...
    <section className="relative bg-grid bg-surface/60 text-main-text">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-title font-bold text-main-text">Our Values</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {values.map((value) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3 text-main-text">{value.title}</h3>
