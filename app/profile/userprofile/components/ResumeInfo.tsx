    ...
    <div className="rounded-2xl border border-subtle bg-surface p-6 shadow-elevated">
      ...
      <div className="flex items-center gap-4 p-4 rounded-lg border border-subtle bg-light-bg">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-main-light-text break-words">{data.resumeFileName}</p>
        </div>
        <div className="flex-shrink-0">
          <button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-subtle bg-surface hover:border-main-accent hover:text-main-accent transition-colors text-sm font-medium">
